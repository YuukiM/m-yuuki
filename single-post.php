      ...
      if (have_posts()) :
        while (have_posts()) : the_post();
          ...
          <main class="blog-page-main">
            <article class="blog-page-article" id="post-<?php the_ID(); ?>">
              <h1 class="blog-page-article__heading">
                <?php the_title(); ?>
              </h1>
              <div class="article-inner">
                <?php
                  ...
                  if ($thumbnail):
                    ?>
                    <picture class="blog-page-article__attachment">
                      <?php echo $thumbnail; ?>
                    </picture>
                  <?php endif; ?>
                <div class="date-cat">
                  ...
                  <div class="blog-page-article__category">
