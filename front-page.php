    ...
    <div id="js-content" class="main-content">
      <section class="above-the-fold">
        ...
        <div class="button-wrap">
          <a href="https://studio-lapin.jp/web-design-support/" target="_blank" class="button button--ghost">
      ...
      <section class="section introduction">
        <div class="contents introduction__contents" id="Introduction">
          ...
          <div class="introduction__lead">
            <p>
              こんにちは！Webデザイン講師 / Webデザイナーの宮崎祐樹です。
            </p>
            <p>
              web業界で18年以上の経験を持ち、webデザイナーとしてもコーダーとしても豊富な経験を持っています。
            </p>
            <p>
            ...
            <ul class="biography-list">
              <li class="biography-list__item">
                <dl class="biography-list__text">
                  <dt>2025</dt>
                  <dd>講師歴5年。700名以上の受講生に教えてきました。</dd>
                </dl>
              </li>
              <li class="biography-list__item">
                <dl class="biography-list__text">
