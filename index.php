	...
	<main>
		<section class="section introduction">
			<div class="contents introduction__contents" id="Introduction">
				...
				<div class="introduction__lead">
					...
					<p>
						14年というWeb業界歴で培った技術を活かしながら、<br class="pc-only">丁寧でわかりやすい説明を心がけています。
					</p>
					<p>
						一緒に楽しく勉強しましょう。
					</p>
				...
				<ul class="biography-list">
					<li class="biography-list__item">
						<dl class="biography-list__text">
							<dt>2022</dt>
							<dd>講師歴2年。400名以上の受講生に教えてきました。</dd>
						</dl>
					</li>
					<li class="biography-list__item">
						<dl class="biography-list__text">
					...
					<li class="biography-list__item">
						<dl class="biography-list__text">
							<dt>2017 – 2020</dt>
							<dd>フリーランスWebデザイナーとして活動開始。アパレル系ECサイトのコーディングや大手企業のLP、製品ページのコーディングなど。</dd>
						</dl>
					</li>
					<li class="biography-list__item">
						<dl class="biography-list__text">
					...
					<li class="biography-list__item">
						<dl class="biography-list__text">
							<dt>2010 - 2013</dt>
							<dd>都内ウェブ制作会社にて、Wordpressを使用したウェブサイトの制作を受け持つ。デザインからテーマの開発、実装までを担当。</dd>
						</dl>
					</li>
					<li class="biography-list__item">
						<dl class="biography-list__text">
		...
		<section class="section skills">
			<div class="contents skills__contents" id="Skills">
				...
				<ul class="skills__primary">
					<li class="skill-item">
						...
						<svg class="skill-item__img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								...
								d="M7.5 21.5v-1h4v-3H3c-.3 0-.5-.2-.5-.5V4c0-.3.2-.5.5-.5h18c.3 0 .5.2.5.5v13c0 .3-.2.5-.5.5h-8.5v3h4v1h-9zm-4-5h17v-12h-17v12z"/>
							<path d="M14.1 11.2c0 2.7-4.3 2.7-4.2 0-.1-2.7 4.3-2.7 4.2 0zm1.1 5.3c.1-4.1-6.4-4.1-6.4 0h6.4z"
										style="stroke-width:.5;stroke-miterlimit:10"/></svg>
					</li>
				</ul>
				<ul class="skills__secondary">
					<li class="skill-item">
						...
						<svg class="skill-item__img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								 style="enable-background:new 0 0 24 24" xml:space="preserve"><path
								d="M9.3 18.4 14 5.6h.8l-4.7 12.8h-.8zM.7 12l4.9-4.9.7.7L2.1 12l4.2 4.2-.6.8-5-5zm16.9 4.2 4.2-4.2-4.2-4.2.7-.7 5 4.9-5 5-.7-.8z"/></svg>
					</li>
					<li class="skill-item">
						<div class="skill-item__text">
							<h3 class="skill-item__heading item-heading">
						...
						<svg class="skill-item__img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								 style="enable-background:new 0 0 24 24" xml:space="preserve"><path
								d="M12 21.8c-2.6 0-5.1-1-6.9-2.9C3.2 17 2.2 14.6 2.2 12c0-2.6 1-5.1 2.9-6.9S9.4 2.2 12 2.2c2.6 0 5.1 1 6.9 2.9 1.9 1.9 2.9 4.3 2.9 6.9 0 2.6-1 5.1-2.9 6.9-1.8 1.9-4.3 2.9-6.9 2.9zm-2.7-1.3.2.1c.8.2 1.6.4 2.5.4 1 0 2-.2 3-.5l.2-.1-.2-.4-2.9-7.8-2.8 8.3zM3.9 8.4c-.5 1.1-.8 2.3-.8 3.6 0 3.4 1.9 6.5 5 8l.4.2L4.1 7.9l-.2.5zm15.9-.7c0 1-.8 3.4-1 4L16 19.9l.5-.3c1.3-.8 2.5-1.9 3.2-3.2.8-1.3 1.2-2.9 1.2-4.4 0-1.5-.4-3-1.1-4.3zM7.6 7.3c.1 0 .2.1.2.2 0 0 0 .1-.1.2 0 0-.5.1-1 .1h-.3L9.8 18l2.1-6.3-1.4-3.9h-.1c-.3 0-.6 0-.9-.1-.1 0-.2-.1-.1-.2 0 0 0-.2.2-.2.1 0 1.5.1 2.3.1.9 0 2.3-.1 2.3-.1.2 0 .2.1.2.2 0 0 0 .1-.1.2 0 0-.5.1-1 .1H13L16.4 18l1.1-3.8c.3-1.1.6-1.9.6-2.6 0-1.1-.4-1.9-.7-2.5l-.1-.2c-.4-.6-.7-1.2-.7-1.8 0-.6.5-1.3 1.3-1.3h.6l-.5-.3c-1.6-1.5-3.8-2.3-6-2.3-1.5 0-2.9.4-4.2 1.1-1.3.6-2.4 1.6-3.2 2.8l-.2.3h.9c.9 0 2.3-.1 2.3-.1z"/></svg>
					</li>
					<li class="skill-item">
						<div class="skill-item__text">
							<h3 class="skill-item__heading item-heading">
			...
			<div class="image-area skills__images">
				...
				<img src="<?php echo get_theme_file_uri('/images/competences-portrait@2x.png'); ?>" alt="テーブルの写真"
						 class="photo photo--large" loading="lazy">
			</div>
		</section>
		<section class="section services-prices">
			<div class="contents services-prices__contents" id="Service">
				...
				<div class="services-prices__item">
					...
					<p>
						Zoomを使用したオンラインレッスンです。全国どこからでも受講可能です。<br>
					</p>
					<p>
						fammのWebデザイン講座で宮崎の講座を受講されたかたは <a href="<?php site_url(); ?>/private-lesson/">こちらをご覧ください</a>。<br>
				...
				<div class="services-prices__item">
					...
					<p>
						カフェなどでの対面でのオンラインレッスンです。東京都近郊の方が対象です。
					</p>
					<div class="prices">
						<h4 class="prices__heading">
							料金
