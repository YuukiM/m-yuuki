      ...
      <div class="lesson-section__inner">
        ...
        <div class="lesson-content">
          ...
          <p>
            ...
            みなさまのデザインを宮崎が<a href="https://codage.studio-lapin.jp/" target="_blank">コーディング学習サイト「Codage」</a>の素材として使わせていただきたいのです。
          ...
          <p>
            また、前述の「Codage」にコーディング課題としてデザインを掲載しますが、その際に皆様のお名前とポートフォリオへのリンクを掲載します。 将来的にはそこからお仕事が来ることもあるかも・・・？
            制作したデザインは実績としてポートフォリオに掲載可能です。
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="lesson-section__inner">
        ...
        <div class="lesson-content">
          <ul class="brush-up-notices">
            ...
            <li>
              期間内に完成させることができず、延長を希望しない場合、制作物を実績として公開することはできません。
            </li>
          </ul>
        </div>
      </div>
